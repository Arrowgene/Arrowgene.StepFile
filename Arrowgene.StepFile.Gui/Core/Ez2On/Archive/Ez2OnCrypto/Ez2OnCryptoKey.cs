namespace Arrowgene.StepFile.Gui.Core.Ez2On.Archive.Ez2OnCrypto
{
    ...
    /// </summary>
    public class Ez2OnCryptoKey
    {
        public static Ez2OnCryptoKey Png()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.png,
                Init = new byte[]
                {
        ...
        public static Ez2OnCryptoKey Bin()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.bin,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
        ...
        public static Ez2OnCryptoKey Str()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.str,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
        ...
        public static Ez2OnCryptoKey Dat()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.dat,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
        ...
        public static Ez2OnCryptoKey Bmp()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.bmp,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
        ...
        public static Ez2OnCryptoKey Jpg()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.jpg,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
        ...
        public static Ez2OnCryptoKey Ogg()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.ogg,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
        ...
        public static Ez2OnCryptoKey Pvi()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.pvi,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
        ...
        public static Ez2OnCryptoKey Scr()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.scr,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
        ...
        public static Ez2OnCryptoKey Ptn()
        {
            return new Ez2OnCryptoKey
            {
                CryptoExtension = Ez2OnCryptoExtension.ptn,
                Init = new byte[]
                {
                    0x78, 0x56, 0x34, 0x12, 0x78, 0x56, 0x78, 0x56, 0x78, 0x56, 0xBC, 0x9A, 0x78, 0x56, 0xFF, 0xDE
                },
